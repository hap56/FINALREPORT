...
$tableGen .= '<tr>';
//it grabs the first element of the array so we can extract the field headings for the table
$fieldHeadings = $array[0];
$fieldHeadings = get_object_vars($fieldHeadings);
$fieldHeadings = array_keys($fieldHeadings);
//it gets the page being viewed so that the table routes requests to the correct controller
